...
window.addEventListener('WebComponentsReady', function () {
    ...
    var HxDisclosure = function (_HTMLElement) {
        _inherits(HxDisclosure, _HTMLElement);

        function HxDisclosure() {
            _classCallCheck(this, HxDisclosure);

            return _possibleConstructorReturn(this, (HxDisclosure.__proto__ || Object.getPrototypeOf(HxDisclosure)).apply(this, arguments));
        }

        _createClass(HxDisclosure, [{
            key: 'connectedCallback',
            value: function connectedCallback() {
...
window.addEventListener('WebComponentsReady', function () {
    ...
    var icons = {
        ...
        'billing': __webpack_require__(13),
        'calendar': __webpack_require__(14),
        'checkmark': __webpack_require__(15),
        'checkmark-circle': __webpack_require__(16),
        'cog': __webpack_require__(17),
        'copy': __webpack_require__(18),
        'download': __webpack_require__(19),
        'envelope': __webpack_require__(20),
        'exclamation-circle': __webpack_require__(21),
        'exclamation-triangle': __webpack_require__(22),
        'export': __webpack_require__(23),
        'external-link': __webpack_require__(24),
        'filter': __webpack_require__(25),
        'help-circle': __webpack_require__(26),
        'info-circle': __webpack_require__(27),
        'input-file': __webpack_require__(28),
        'input-time': __webpack_require__(29),
        'input-url': __webpack_require__(30),
        'kbd-arrow-down': __webpack_require__(31),
        'kbd-arrow-left': __webpack_require__(32),
        'kbd-arrow-right': __webpack_require__(33),
        'kbd-arrow-up': __webpack_require__(34),
        'kbd-capslock': __webpack_require__(35),
        'kbd-command': __webpack_require__(36),
        'kbd-delete': __webpack_require__(37),
        'kbd-eject': __webpack_require__(38),
        'kbd-option': __webpack_require__(39),
        'kbd-return': __webpack_require__(40),
        'kbd-shift': __webpack_require__(41),
        'kbd-space': __webpack_require__(42),
        'kbd-tab': __webpack_require__(43),
        'lock': __webpack_require__(44),
        'minus': __webpack_require__(45),
        'minus-circle': __webpack_require__(46),
        'monitoring': __webpack_require__(47),
        'pencil': __webpack_require__(48),
        'phone': __webpack_require__(49),
        'plus': __webpack_require__(50),
        'plus-or-minus': __webpack_require__(51),
        'search': __webpack_require__(52),
        'server': __webpack_require__(53),
        'sort': __webpack_require__(54),
        'sort-down': __webpack_require__(55),
        'sort-up': __webpack_require__(56),
        'support': __webpack_require__(57),
        'tag': __webpack_require__(58),
        'ticketing': __webpack_require__(59),
        'times': __webpack_require__(60),
        'times-circle': __webpack_require__(61),
        'trash': __webpack_require__(62),
        'user': __webpack_require__(63)
    };

    template.innerHTML = '\n        <style>' + __webpack_require__(64) + '</style>\n        <slot></slot>\n    ';
...
window.addEventListener('WebComponentsReady', function () {
    ...
    template.innerHTML = '\n      <style>' + __webpack_require__(68) + '</style>\n      ' + __webpack_require__(1) + '\n    ';
...
window.addEventListener('WebComponentsReady', function () {
    ...
    template.innerHTML = '\n        <style>' + __webpack_require__(70) + '</style>\n        ' + __webpack_require__(71) + '\n    ';
